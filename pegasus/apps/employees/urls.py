...
urlpatterns = [
    ...
    path("objects/profiles/", views.profiles_list_htmx, name="htmx_profiles_list"),
    path("objects/profiles_table/", views.create_profiles_table, name="htmx_profiles_table"),
    path("objects/related/", views.relevant_table, name="relevant_table"),
    path("objects/htmx/relevant/<int:rel_id>/<str:relevant_bool>/", views.set_relevant, name="set_relevant"),
    path("objects/htmx/set_relevant_table/<str:table_type>/", views.set_relevant_table, name="set_relevant_table"),
]
